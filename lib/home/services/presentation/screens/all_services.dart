...
import 'package:kraba/home/services/presentation/screens/resturant_bar.dart';
      ...
      builder: (context, state) => Scaffold(
        ...
        body: ConditionalBuilder(
          ...
          builder: (context) => ListView.builder(
              ...
              itemCount: ServiceCubit.get(context).serviceModel!.data.length,
                  ...
                  onTap: () {
                    if (index == 1) {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const RestaurantAndCafe()));
                    }
                  },
                  child: Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: Container(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: ServiceCubit.get(context)
                                      .serviceModel!
                                      .data[index]
                                      .photo!,
